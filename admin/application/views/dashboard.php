    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-xs-12">
        <a href="#"><div class="user-bg">
          ...
          <span class="to-user">Pending Orders: <?php echo $total_pending_product;?> pending</span>
          <span class="to-user">Confirm Orders: <?php echo $total_confirm_product;?> confirmed</span>
        </div></a>
      </div>
    </div>
  </div>
