 ...
 ?>
    <div class="right_col" role="main" style="min-height: 3512px!important;">
        <div class="col-md-8 col-xs-12">
            <div class="dash1">
                <div class="head1"><img src="<?php echo base_url('/assets/test/images/dash.png '); ?>">
                    <h1>Dashboard</h1>
                </div>
                <div class="wel-admin">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <div class="not_bg">
                                ...
                                <ul class="list-inline">
                                    <li class="clr_blue"><span
                                            class="clr1"></span><?php echo count($today_complaints);?> Notification</li>
                                    <li class="clr_green"><span class="clr2"></span><?php echo $today_product_new;?> New
                                        Products</li>
                                    <li class="clr_red"><span class="clr3"></span><?php echo $today_user_new;?> New
                                        Users</li>
                                </ul>
                            </div>
                        </div>
...
?> </span>
                            <span class="time1">Time :
                                <?php echo date('h:i a', strtotime($this->session->userdata('last_login'))); ?></span>
                        </div>
                ...
                <div class="users-sec">
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <a href="#">
                                <div class="user-bg">
                                    <img src="<?php echo base_url('/assets/test/images/user_icon.png'); ?>"
                                        class="img2">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <a href="#">
                                <div class="user-bg">
                                    <img src=" <?php echo base_url('/assets/test/images/revenue_icon.png'); ?>"
                                        class="img2">
            ...
            if(!empty($year_revenue)) { 
                  ...
                  if($year->currency_type == 'euro' && $year->currency_type != 'usd'){
                     echo $euroamount = '£'.$year->total;
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <a href="#">
                                <div class="user-bg">
                                    <img src="<?php echo base_url('/assets/test/images/order_icon.png'); ?>"
                                        class="img2">
                                    <h2 class="head3">Orders</h2>
                                    <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>
                                    <span class="to-user">Total Orders: <?php echo $total_product;?> in Total</span>
                                    <span class="to-user">Pending Orders: <?php echo $total_pending_product;?>
                                        pending</span>
                                    <span class="to-user">Confirm Orders: <?php echo $total_confirm_product;?>
                                        confirmed</span>
                                </div>
                            </a>
                        </div>
                ...
                <div class="product-sec1">
                    ...
                    <a href="<?php echo base_url('index.php/Admin/product_list'); ?>" class="btn1"><span>View
                            All</span><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    <div class="pro-table">
        ...
        <div class="col-md-4 col-xs-12">
            <div class="dash2">
                <div class="subs-user">
                    <div class="head-sec">
                        <h1 class="head5">Subscription Details</h1>
                        <a href="<?php echo base_url('index.php/Admin/Subscription'); ?>" class="btn1"><span>View
                                All</span><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
          ...
          foreach ($subsribed_user as $usr) {
            ...
            ?>
                    <ul class="list-unstyled text-bg">
                        ...
                        <li><?php //echo $uname;?>********<span>Subscribed Date: <?php echo $usr['start_date']; ?> |
                                Subscription Expire Date: <?php echo $usr['start_date']; ?> </span></li>
                    </ul>
                    <?php
          }
        }else{
    ...
    ?>
                ...
                <div class="subs-user">
                    <div class="head-sec">
                        <h1 class="head5">Featured Details</h1>
                        <a href="<?php echo base_url('index.php/Admin/feature_subscription'); ?>"
                            class="btn1"><span>View All</span><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
          ...
          foreach ($product_booking as $fbook) {
            ...
            ?>
                    <ul class="list-unstyled text-bg">
                        <li><img src="<?php echo base_url('/assets/test/images/user1.png'); ?>"></li>
                        <li><?php echo $fbook['product_name']?><span>Featured Date: <?php echo $fbook['start_date']?> |
                                Expire Date: <?php echo $fbook['expiry_date']?> </span></li>
                    </ul>
                    <?php
          }
        }else{
    ...
    ?>
                ...
                <div class="subs-user">
                    <div class="head-sec">
                        <h1 class="head5">Complaints</h1>
                        <a href="<?php echo base_url('index.php/Admin/complaints'); ?>" class="btn1"><span>View
                                All</span><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
