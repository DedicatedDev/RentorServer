                     ...
                     echo form_open_multipart($url, $attributes); ?>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <label class="control-label col-sm-2" for="first-name"><input type="radio" name="cstatus" value="1" checked="checked">Active
                        </label>
                          
                           <label class="control-label col-sm-2" for="first-name"><input type="radio" name="cstatus" value="0">Inactive
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <div class="col-sm-12 col-xs-12">
                          <a class="btn btn4" href="<?php echo base_url('index.php/Admin/category_list'); ?>">Cancel</a>
...
">Status</label>
  ...
  <div class="drp-btn-bg"><a class="dropdown-item btn3 w100" href="<?php echo base_url('index.php/Admin/category_list?status='.base64_encode('1')); ?>" cstatus="3" style="padding: 2px 6px;font-size: 14px;">Active</a></div>
  <div class="drp-btn-bg"><a class="dropdown-item btn4 w100" href="<?php echo base_url('index.php/Admin/category_list?status='.base64_encode('0')); ?>" cstatus="5" style="padding: 2px 6px;font-size: 14px;">Inactive</a></div>
                  ...
                  <?php if($category->status==1){ 
                   ...
                   <td>
                              ...
                              <?php
                               ...
                               <a class="btn btn-round btn-primary round-btn" href="<?php echo base_url('/index.php/Admin/category_list');?>?id=<?php echo $category->id; ?>&status=1&request=2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
