            ...
            <div class="row">
              ...
              <input class="input-file" id="icon" type="file" section="subcat">
                      ...
                      <div class="form-group icon-show" <?php if(!empty($sub_cat_data->sub_cat_icon)){ ?>style="display: block;"<?php } else{ ?>style="display: none;"<?php } ?>>
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-5 col-form-label label-text" for="first-name">Sub Category Image
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-7">
                          
                          <div class="input-file-container">

              <input class="input-file" id="image" section="subcat" type="file" name="files[]" multiple>
                      ...
                      <div class="form-group show-image" <?php if(!empty($sub_cat_data->sub_cat_image)){ ?>style="display: block;"<?php } else{ ?>style="display: none;"<?php } ?>>
                        <label class="control-label col-md-4 col-form-label label-text" for="first-name">
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-7">
                           <div id='preview_image'>
                            <?php 
                            if(!empty($sub_cat_data->sub_cat_image)){
                              $image = json_decode($sub_cat_data->sub_cat_image);
                              $ci = 0;
                              
                              foreach($image as $img){ 
                                $urlc = str_replace("/admin","",base_url());
                                $cimg = str_replace($urlc.'uploads/subcategory/',"",$img->image);
                                ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <label class="control-label col-sm-3 label-text" for="first-name"><input type="radio" name="cstatus" value="1" checked="checked"> Active
                            ...
                            <label class="control-label col-sm-3 label-text" for="first-name"><input type="radio" name="cstatus" value="0"> Inactive
                        </div>
                      </div>
                      
                      <div class="form-group">
                        <div class="col-xs-12">
                          <a class="btn btn4 marg10" href="<?php echo base_url('index.php/Admin/add_subcategory'); ?>">Cancel</a>
                     ...
                     <div class="col-sm-6 col-xs-12 scrl1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-9">
                          <input type="text" name="" maxlength="30" readonly class="form-control col-md-7 col-xs-12 input1" value="Name">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-9">
                          <input type="text" name="" maxlength="30" readonly class="form-control col-md-7 col-xs-12 input1" value="Description">
                        </div>
                      </div>
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-9">
                          <input type="text" name="" maxlength="30" readonly class="form-control col-md-7 col-xs-12 input1" value="Minimum Booking amount">
                        </div>
                      </div>
                       <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-9">
                          <input type="text" name="" maxlength="30" readonly class="form-control col-md-7 col-xs-12 input1" value="Price">
                        </div>
                      </div>
             ...
             foreach ($subcategory as $subcategory) {
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-round btn-primary round-btn" href="<?php echo base_url('/index.php/Admin/subcategory_list');?>?id=<?php echo $subcategory->id; ?>&status=1&request=2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                  </td> 
