            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="javascript:void(0)" class="site_title"><img
                                src="<?php echo base_url('/assets/images/logo2.png'); ?>">
                            <span class="rent-text" style="color:white">
                                <?php echo explode(" ",getenv('SIDE_BAR_HEADING'))[0];?>
                            </span>
                            <span class="rent-text">
                                <?php echo explode(" ",getenv('SIDE_BAR_HEADING'))[1];?>
                            </span>
                        </a>
                        <span><?php echo getenv('SIDE_BAR_HEADING');?></span></a>
                    </div>
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="<?php echo base_url('/assets/images/faces/face16.jpg'); ?>" alt="..."
