<?php
 ...
 $query = $this->db->query($sql);
        ...
        public function get_subcription($where){
            $this->db->select('subscription.id,subscription.title,subscription.description,subscription.type,subscription.price,subscription.period,subscription.currency_type,subscription.status,subscription_period.period_title');
        ...
        public function getAllUserData($table,$status){
            $this->db->select('users.id, users.name,users.email,user_profile.mobile,users.status,user_profile.country_code');
            $this->db->from('users');
